...
"}")
        ...
        self.tfPassword.setEnabled(True)
        self.tfPassword.setMaximumSize(QtCore.QSize(300, 26))
        self.tfPassword.setFrame(True)
        self.tfPassword.setEchoMode(QtWidgets.QLineEdit.EchoMode.Password)
        self.tfPassword.setObjectName("tfPassword")
        self.gridLayout_2.addWidget(self.tfPassword, 2, 3, 1, 1)
        self.verticalLayout.addLayout(self.gridLayout_2)
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.btnIniciarSesion = QtWidgets.QPushButton(parent=Frame)
        self.btnIniciarSesion.setMaximumSize(QtCore.QSize(150, 16777215))
        self.btnIniciarSesion.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.btnIniciarSesion.setObjectName("btnIniciarSesion")
        self.horizontalLayout_3.addWidget(self.btnIniciarSesion)
        self.btnCancelar = QtWidgets.QPushButton(parent=Frame)
        self.btnCancelar.setMaximumSize(QtCore.QSize(150, 16777215))
    ...
    def retranslateUi(self, Frame):
        ...
        self.label.setText(_translate("Frame", "Login"))
        self.label_7.setText(_translate("Frame", "Password"))
        self.label_9.setText(_translate("Frame", "Email"))
        self.btnIniciarSesion.setText(_translate("Frame", "Iniciar Sesion"))
        self.btnCancelar.setText(_translate("Frame", "Cancelar"))
